...
class TelloUI:
    ...
    def __init__(self,tello,outputpath):
        ...
        self.btn_landing = tki.Button(
            self.root, text="Open Control Panel", relief="raised", command=self.openCmdWindow)
        ...
        self.root.wm_title("Tello Drone Assignment")
    ...
    def openCmdWindow(self):
        ...
        self.btn_landing = tki.Button(
            panel, text="Preplanned Route", relief="raised", command=self.runPreplanRoute)
        self.btn_landing.pack(side="bottom", fill="both",
                              expand="yes", padx=10, pady=5)
        self.btn_landing = tki.Button(
            panel, text="Manual Override", relief="raised", command=self.stop_movement)
        self.btn_landing.pack(side="bottom", fill="both",
                              expand="yes", padx=10, pady=5)
    ...
    def runPreplanRoute(self):
        ...
        self.tello.send(frombase[0] + " " + str(frombase[1]), 4)
        self.tello.send(frombase[2] + " " + str(frombase[3]), 4)
        ...
        for i in range(len(checkpoint)):
            if i == len(checkpoint) - 1:
                ...
                if self.interrupt == True:
                    print('Manual Overriding.....')
                    break

            self.tello.send(checkpoint[i][1] + " " + str(checkpoint[i][2]), 4)
            self.tello.send(checkpoint[i][3] + " " + str(checkpoint[i][4]), 4)
        ...
        self.tello.send(tobase[0] + " " + str(tobase[1]), 4)
        self.tello.send(tobase[2] + " " + str(tobase[3]), 4)
